    ...
    for idx,i in enumerate(data['annotations']):
       # print(i[idx])
        ...
        if i['image_id'] in dict_nine:
            dict_nine[i['image_id']].append(str(i['category_id']-1)+" "+str(i['bbox'][0]*0.59259259259259)+" "+str(i['bbox'][1]*0.33333333)+" "+str(i['bbox'][2]*0.59259259259259)+" "+str(i['bbox'][3]*0.33333333))
        else:    
            dict_nine[i['image_id']] = [str(i['category_id']-1)+" "+str(i['bbox'][0]*0.59259259259259)+" "+str(i['bbox'][1]*0.33333333)+" "+str(i['bbox'][2]*0.59259259259259)+" "+str(i['bbox'][3]*0.33333333)]
